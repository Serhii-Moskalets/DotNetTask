...
namespace DotNetTask.Infrastructure.Persistence.UnitOfWork;
...
{
    private readonly IDotNetTaskDbContext _dbContext;
    ...
    {
        List<BaseEntity> domainEntities = this._dbContext.ChangeTracker
            .Entries<BaseEntity>()
        ...
        foreach (BaseEntity entity in domainEntities)
        {
