...
public static class EmailPolicy
{
    ...
    /// <summary>
    /// Regex pattern to ensure email does not contain angle brackets.
    /// </summary>
    public const string NoAngleBracketsRegex = "^[^<>]+$";

    /// <summary>
    /// Error message for null or empty email
    /// .</summary>
    ...
    /// <summary>
    /// Error message when the new email is the same as the current one.
    /// </summary>
    public const string SameAsCurrentMessage = "New email is same as current.";

    /// <summary>
    /// Error message when the email is already associated with another account.
    /// </summary>
    public const string AlreadyInUseMessage = "This email is already in use.";

    /// <summary>
    /// Error message when the email has not been confirmed.
    /// </summary>
