...
public class LastNameTests
{
    ...
    {
        // Act
        LastName result = LastName.Create(input);
    ...
    {
        // Act
        LastName? result = LastName.CreateOptional(Name);
    ...
    {
        // Arrange
        LastName lastName = LastName.Create(Name);
    ...
    {
        // Arrange
        LastName name1 = LastName.Create(Name);
        LastName name2 = LastName.Create(Name);
