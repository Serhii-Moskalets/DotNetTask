...
public class SecurityStampTests
{
    ...
    {
        // Act
        SecurityStamp stamp1 = SecurityStamp.New();
        SecurityStamp stamp2 = SecurityStamp.New();
    ...
    public void Create_Should_InitializeValue_When_InputIsValid()
    {
        ...
        // Act
        SecurityStamp stamp = SecurityStamp.Create(rawValue);
    ...
    public void Equality_Should_BeBasedOnValue()
    {
        ...
        SecurityStamp stamp1 = SecurityStamp.Create(rawValue);
        SecurityStamp stamp2 = SecurityStamp.Create(rawValue);
        SecurityStamp stamp3 = SecurityStamp.Create("different-value");
