...
public class UpdateUsernameCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new UpdateUsernameCommand("ValidUsername", Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new UpdateUsernameCommand(username!, Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new UpdateUsernameCommand("ValidUser", Guid.Empty);
