...
public class TaskListTitleTests
{
    ...
    public void Create_ShouldReturnInstance_WhenValid()
    {
        ...
        // Act
        var result = TaskListTitle.Create(input);
    ...
    public void Create_ShouldThrow_WhenValueIsNullOrWhiteSpace(string? invalidValue)
    {
        ...
        act.Should()
            ...
            .WithMessage("Task list title cannot be empty.");
    }
    ...
    {
        // Arrange
        var tooLong = new string('z', TaskListTitle.MaxLength + 1);
        ...
        act.Should()
            .Throw<DomainException>()
            .WithMessage($"Task list title cannot exceed {TaskListTitle.MaxLength} characters.");
    }
    ...
    public void ToString_ShouldReturnValue()
    {
        ...
        // Act
        var result = TaskListTitle.Create(text);
    ...
    public void ShouldBeEqual_WhenValuesAreSame()
    {
        ...
        var first = TaskListTitle.Create(sharedTitle);
        var second = TaskListTitle.Create(sharedTitle);
    ...
    {
        // Arrange & Act
        var first = TaskListTitle.Create("First Title");
        var second = TaskListTitle.Create("Second Title");
