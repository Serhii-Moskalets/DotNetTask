...
public class TaskTitleTests
{
    ...
    public void Create_ShouldReturnInstance_WhenValid()
    {
        ...
        // Act
        var result = TaskTitle.Create(input);
    ...
    public void Create_ShouldThrow_WhenValueExceedsMaxLength()
    {
        ...
        act.Should()
            .Throw<DomainException>()
            .WithMessage($"Task title cannot exceed {TaskTitle.MaxLength} characters.");
    }
    ...
    {
        var result = TaskTitle.CreateOptional(input);
    ...
    public void ToString_ShouldReturnValue()
    {
        ...
        var result = TaskTitle.Create(text);
    ...
    {
        var first = TaskTitle.Create("Same Title");
        var second = TaskTitle.Create("Same Title");
    ...
    {
        var first = TaskTitle.Create("First Title");
        var second = TaskTitle.Create("Second Title");
